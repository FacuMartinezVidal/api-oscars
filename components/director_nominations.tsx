...
const DirectorNominations = () => {
  ...
  useEffect(() => {
    if (
      mongoDirector.isFetched &&
      cassandraDirector.isFetched &&
      sqlDirector.isFetched
    ) {
      setIsSearching(false);
    }
  }, [
  ...
  const renderSkeleton = () => (
    <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg overflow-hidden shadow-lg border border-orange-200 p-8 mb-6">
              ...
              {!isSearching && (
                <>
                  ...
                  {cassandraDirector.error && (
                    <div className="text-center text-red-600">
                      Error al buscar el director:{" "}
                      {cassandraDirector.error.message}
                    </div>
                  )}
                    ...
                    >
                      ...
                      {cassandraDirector.data.nominations && (
                        <div className="mt-8">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {cassandraDirector.data.nominations.map(
                              (nom, idx) => (
                                <motion.div
                                  key={idx}
                                  initial={{ opacity: 0, scale: 0.8 }}
                  ...
                  {!cassandraDirector.data && !cassandraDirector.isFetching && (
                    <div className="text-center text-gray-600 mt-4">
                      No se encontraron nominaciones para este director en
                      Cassandra
                    </div>
                  )}
                </>
